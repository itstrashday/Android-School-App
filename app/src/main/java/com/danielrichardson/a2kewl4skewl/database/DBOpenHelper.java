...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String[] TERMS_COLUMNS = {TERMS_TABLE_ID, TERM_NAME, TERM_START, TERM_END, TERM_STATUS, TERM_CREATED};
    ...
    public static final String COURSE_MENTOR_NAME = "courseMentor";
